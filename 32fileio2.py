...
# csv.reader : 파일 객체를 직접 전달해서 자동으로 줄단위로 읽음
...
# 파일 쓰기 4
# 사용자로부터 이름, 이메일, 주소등을 입력받아 persons.csv로 저장
name = 'abc123'
...
# 파일 쓰기 5
# 사용자로부터 이름, 이메일, 주소등을 입력받아 persons2.csv로 저장
...
# 사람이 읽기 쉽고, 프로그램도 읽기 쉬운 구조화된 텍스트 데이터 형식

# CSV : 입력받은 내용을 모두 문자열로 취급해 파일에 저장
#        -> 데이터의 의미를 프로그램이 파악하기 어려움
#        구조 파악 어려움 : split함수를 이용해서 구조 해석
